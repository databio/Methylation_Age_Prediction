...
file_in <- "HPC_1_S26746_epilog.bed" #Input filename
file_out <- "HPC1_Output_Processed.cov"#Output filename
#Output File Can be Loaded into Methylation-Age Prediction
